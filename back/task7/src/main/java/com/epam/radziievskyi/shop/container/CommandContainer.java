...
public class CommandContainer {
    ...
    private final Map<String, Command> commandContainer;
    ...
    private void fillCommandsMap() {
        ...
        commandContainer.put("13", new AddProductCommandImpl(applicationContext.getProductService(), applicationContext.getStrategy()));
        commandContainer.put("14", new AddProductReflectionCommandImpl(applicationContext.getProductService(), applicationContext.getStrategy(), applicationContext.getResourceBundle()));
