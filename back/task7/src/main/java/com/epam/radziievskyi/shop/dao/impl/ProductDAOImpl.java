...
public class ProductDAOImpl implements ProductDAO {
    ...
    public ProductDAOImpl(ResourceBundle bundle) {
        this.bundle = bundle;
    }
    ...
    @Override
    public void addProductReflection(AbstractMethodTemplate abstractMethodTemplate) throws IOException {
        allProducts.add(abstractMethodTemplate.getVehicle());
    }
}
