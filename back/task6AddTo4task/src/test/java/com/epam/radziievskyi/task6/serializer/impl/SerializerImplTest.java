...
class SerializerImplTest {
    ...
    void shouldSerializeFileWhenCallsMethodSerialize() {
        ...
        //when
        serializerImplMock.serialize(Collections.singletonList(vehicles));

        //then
        Assertions.assertDoesNotThrow(() -> serializerImplMock.serialize(Collections.singletonList(vehicles)));
