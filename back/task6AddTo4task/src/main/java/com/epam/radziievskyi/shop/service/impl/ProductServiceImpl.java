...
public class ProductServiceImpl implements ProductService, Strategy {
    ...
    private void addSeaVehicle (Scanner scanner) {
        ...
        productDAO.addProduct(new SeaVehicle
    ...
    private void addElectroCar (Scanner scanner) {
        ...
        productDAO.addProduct(new ElectroCar
    ...
    private void addBenzoCar (Scanner scanner) {
        ...
        productDAO.addProduct(new BenzoCar
